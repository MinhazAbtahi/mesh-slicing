...
using BzKovSoftSlice.ObjectSlicer.EventHandlers;
...
#pragma warning restore 0649
		...
		private BzSliceTryResult ApplyChanges(SliceTry sliceTry)
        {
            ...
            //StartCoroutine(SliceMainThread(sliceTry, resultObjNeg, resultObjPos, renderersNeg, renderersPos));
        ...
        private IEnumerator SliceMainThread(SliceTry sliceTry, GameObject resultObjNeg, GameObject resultObjPos, Renderer[] renderersNeg, Renderer[] renderersPos)
        {
